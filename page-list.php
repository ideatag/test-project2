    ...
    while ($row = $result->fetch_assoc()) {
        echo '<tr>
            ...
            <td style="text-align: center; padding: 12px; border: 1px solid #ddd;">
                ...
                <a href="page.php?action=delete&id=' . $row['id'] . '" style="border: 1px solid #ccc; background-color: #f8f9fa; padding: 4px; border-radius: 4px; text-decoration: none; color: #dc3545; display: inline-block;">Delete</a>
            </td>
