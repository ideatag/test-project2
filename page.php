...
?>
        ...
        <form method="post" action="page.php?action=add" style="max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 5px;">
            ...
            <div style="margin-bottom: 12px;">
                ...
                <textarea id="continut" name="continut" value="<?php echo $row['continut']; ?>" required style="resize: none; height: 72px; width: 100%; padding-top:8px; padding-bottom:8px;  margin-right:8px; border: 1px solid #ccc; border-radius: 4px;"></textarea>
            </div>
            <div style="margin-bottom: 12px;">
    ...
    ?>
        ...
        <form method="post" action="page.php?action=edit&id=<?php echo $id; ?>" style="max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 5px;">
            <div style="margin-bottom: 12px;">
                <label for="name" style="font-family: Arial, sans-serif;">Name:</label><br>
                <input type="text" id="name" name="name" value="<?php echo $row['name']; ?>" required style="width: 100%; padding-top:8px; padding-bottom:8px; border: 1px solid #ccc; border-radius: 4px;">
            </div>
            <div style="margin-bottom: 12px;">
                <label for="continut" style="font-family: Arial, sans-serif;">Continut:</label><br>
                <textarea id="continut" name="continut" value="<?php echo $row['continut']; ?>" required style="resize: none; height: 72px; width: 100%; padding-top:8px; padding-bottom:8px;  margin-right:8px; border: 1px solid #ccc; border-radius: 4px;"></textarea>
            ...
            <div style="margin-bottom: 12px;">
                <label for="data" style="font-family: Arial, sans-serif;">Data:</label><br>
                <input type="datetime-local" id="data" name="data" value="<?php echo $row['data']; ?>" required style="width: 100%; padding-top:8px; padding-bottom:8px;  border: 1px solid #ccc; border-radius: 4px;">
            </div>
            <div style="text-align: center;">
    ...
    if ($result->num_rows > 0) {
        ...
        echo '<table style="width:100%; border: 1px solid #ddd; border-collapse: collapse; margin: 20px 0; font-family: Arial, sans-serif;">
            ...
            <tr>
                ...
                <td style="text-align: center; padding: 12px; border: 1px solid #ddd;">' . $formattedDate . '</td>
            </tr>
            </tbody>
        </table>';
    } else {
